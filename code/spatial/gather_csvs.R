...
wave12_file <- "projections__stroop__rda__n_resamples100__demean_run__cv_allsess_wave12.csv"
wave13_file <- "projections__stroop__rda__n_resamples100__demean_run__cv_allsess_wave13.csv"
wave23_file <- "projections__stroop__rda__n_resamples100__demean_run__cv_allsess_wave23.csv"
output_file <- "projections__stroop__rda__n_resamples100__demean_run__cv_allsess.csv"
